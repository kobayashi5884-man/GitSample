    ...
    while cap.isOpened():#0.04
        ...
        if ret:
            ...
            if len(face_rects) > 0:
                ...
                if euler_angle[1,0]<26 and euler_angle[1,0]>-26 and lump.state != 'tooMuchLook' and lump.state !='delayS' or lump.state == 'delayT':
                    if lump.state =='seek':
                        lump.look()
                    else:
                ...
                elif euler_angle[1,0]>30 or euler_angle[1,0]<-30 or lump.state == 'tooMuchLook' or lump.state == 'delayS' and lump.state != 'delayT':
